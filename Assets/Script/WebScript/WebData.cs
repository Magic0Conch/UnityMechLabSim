...
static class WebData
{
    ...
    /// <summary>API 根地址，用于 /files/ 等静态资源（由 connectUri 推导）。</summary>
    public static string ApiBase
    {
        get
        {
            ...
            const string suffix = "/api/values";
            if (connectUri.EndsWith(suffix, System.StringComparison.OrdinalIgnoreCase))
                return connectUri.Substring(0, connectUri.Length - suffix.Length);
            return connectUri.TrimEnd('/');
        }
    }
